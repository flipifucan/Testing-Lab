...
- [x] [02. Creating and Restoring Backups with `tar`](#02-creating-and-restoring-backups-with-tar)
- [x] [03. Activity: Creating and Restoring Backups with `tar`](#03-activity-creating-and-restoring-backups-with-tar-activity)
- [x] [04. Activity Review: Creating and Restoring Backups with `tar`](#04-activity-review-creating-and-restoring-backups-with-tar)
- [x] [05. Restoring Data with Incremental Backups](#05-restoring-data-with-incremental-backups)
- [x] [06. Activity: Restoring Data with Incremental Backups](#06-activity-restoring-data-with-incremental-backups-activity)
- [x] [07. Activity Review: Restoring Data with Incremental Backups](#07-activity-review-restoring-data-with-incremental-backups)
- [x] [08. Break](#08-break)
- [x] [09. Exploiting the `tar` Command with the Checkpoint and Wildcard Options](#09-exploiting-the-tar-command-with-the-checkpoint-and-wildcard-options)
- [x] [10. Activity: Exploiting the `tar` Command with the Checkpoint and Wildcard Options](#10-activity-exploiting-the-tar-command-with-the-checkpoint-and-wildcard-options-activity)
- [x] [11. Activity Review: Exploiting the `tar` Command with the Checkpoint and Wildcard Options](#11-activity-review-exploiting-the-tar-command-with-the-checkpoint-and-wildcard-options)
