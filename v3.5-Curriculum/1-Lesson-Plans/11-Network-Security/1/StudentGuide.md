...
- Day 1 Introduces you to firewalls and defense in depth. Day 2 Introduces you to IDS systems and Network Security Monitoring. Day 3 starts by introducing you to the Cyber Kill chain and then culminates with you exercising your threat hunting skills through the use of Enterprise Security Monitoring.

- Today, we will review the relationship of ports and services, including the role of open ports as the principal **attack surface** of networked machines.	Then, we'll cover how firewalls are used to control access to a machine's open ports, protecting the machine from attackers on the network. We will apply these concepts in exercises that require uncomplicated firewall (UFW) and firewall configurations.
...
- Go to a terminal and use the following command `wget https://gist.githubusercontent.com/jlow3939/904eb58af3605457255df35c649f9873/raw/69bc0efdb38837ecce8db14662e9efffbfe15429/docker-compose.yml && docker-compose up -d`
...
- [x] [01. Module Introduction](#01-module-introduction)
- [x] [02. Firewall Architectures](#02-firewall-architectures)
- [x] [03. UFW Overview and Demonstration](#03-ufw-overview-and-demonstration)
- [x] [04. Activity: Configuring UFW](#04-activity-configuring-ufw)
- [x] [05. Activity Review: Configuring UFW](#05-activity-review-configuring-ufw)
- [x] [06. Break](#06-break)
- [x] [07. firewalld Introduction](#07-firewalld-introduction)
- [x] [08. Activity: Firewalld Configuration](#08-activity-firewalld-configuration)
- [x] [09. Activity Review: Firewalld Configuration](#09-activity-review-firewalld-configuration)
- [x] [10. Testing Firewall Rules with NMAP](#10-testing-firewall-rules-with-nmap)
- [x] [11. Activity: Testing Firewall Rules with Nmap](#11-activity-testing-firewall-rules-with-nmap)
- [x] [12. Activity Review: Testing Firewall Rules with Nmap](#12-activity-review-testing-firewall-rules-with-nmap)
- [x] [13. [Optional] Class Summary](#13-class-summary)


### Slideshow

- The lesson slides are available on Google Drive here: [11.1 Slides](https://docs.google.com/presentation/d/124oo7NmWXYIMr23vAX-QQdoDTqqcwjRakew_gTak4GQ/edit#slide=id.g4789b2c72f_0_6/edit) 
...
### 05. Activity Review: Configuring UFW
...
### 08. Activity: firewalld Configuration 
...
### 09. Activity Review: firewalld Configuration
...
### 11. Activity: Testing Firewall Rules with Nmap 
...
### 12. Activity Review: Testing Firewall Rules with Nmap
