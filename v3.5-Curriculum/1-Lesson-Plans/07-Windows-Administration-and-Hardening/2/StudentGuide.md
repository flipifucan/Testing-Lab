...
- [x] [02. Intro to PowerShell](#02-intro-to-powershell)
- [x] [03. Activity: Move and Create Directories](#03-activity-move-and-create-directories)
- [x] [04. Activity Review: Move and Create Directories Activity](#04-activity-review-move-and-create-directories)
- [x] [05. Generating Windows Event Log Files with Parameters and Pipelines](#05-generating-windows-event-log-files-with-parameters-and-pipelines)
- [x] [06. Activity: Generating Windows Event Log Files with Parameters and Pipelines](#06-activity-generating-windows-event-log-files-with-parameters-and-pipelines)
- [x] [07. Break](#07-break)
- [x] [08. Activity Review: Generating Windows Event Log Files with Parameters and Pipelines Activity](#08-activity-review-generating-windows-event-log-files-with-parameters-and-pipelines)
- [x] [09. Scripting with PowerShell](#09-scripting-with-powershell)
- [x] [10. Activity: Removing Unnecessary Packages with PowerShell](#10-activity-removing-unnecessary-packages-with-powershell)
- [x] [11. Activity Review: Removing Unnecessary Packages with PowerShell](#11-activity-review-removing-unnecessary-packages-with-powershell)
...
- [Solution Guide](Activities/03_Move_and_Create_Dir/Solved/Readme.md)
...
### 08. Activity Review: Generating Windows Event Log Files with Parameters and Pipelines
...
### 10. Activity: Removing Unnecessary Packages with PowerShell
...
### 11. Activity Review: Removing Unnecessary Packages with PowerShell

- [Solution Guide](./Activities/09_Removing_Packages/Solved/Readme.md)
