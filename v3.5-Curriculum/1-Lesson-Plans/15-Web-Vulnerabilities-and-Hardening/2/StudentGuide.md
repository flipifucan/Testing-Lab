...
- [x] [01. Intro to Back-End Component Vulnerabilities](#01-intro-to-back-end-component-vulnerabilities)
- [x] [02. Directory Traversal](#02-directory-traversal)
- [x] [03. Activity: Directory Traversal](#03-activity-directory-traversal)
- [x] [04. Activity Review: Directory Traversal](#04-activity-review-directory-traversal)
- [x] [05. Break](#05-break)
- [x] [06. Web Application Back-End Code](#06-web-application-back-end-code)
- [x] [07. Local File Inclusion](#07-local-file-inclusion)
- [x] [08. Activity: Local File Inclusion](#08-activity-local-file-inclusion)
- [x] [09. Activity Review: Local File Inclusion](#09-activity-review-local-file-inclusion-activity)
- [x] [10. Remote File Inclusion](#10-remote-file-inclusion)
- [x] [11. Activity: Remote File Inclusion](#11-activity-remote-file-inclusion)
- [x] [12. Activity Review: Remote File Inclusion](#12-activity-review-remote-file-inclusion)

## Slideshow 

- [15.2 Slides](https://docs.google.com/presentation/d/1hIIzvqDHKtLSygkVg_e_47bwx0jWHzPnSKasmTAURvQ/edit).
...
### 06.  Web Application Back-End Code 
...
### 08. Activity: Local File Inclusion 
...
### 09. Activity Review: Local File Inclusion Activity
...
### 11. Activity: Remote File Inclusion 
...
### 12. Activity Review: Remote File Inclusion
