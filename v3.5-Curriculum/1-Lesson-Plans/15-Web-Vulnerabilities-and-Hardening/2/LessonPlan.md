...
- [x] [01. Instructor Do: Intro to Back-End Component Vulnerabilities](LessonPlan.md#01-instructor-do-intro-to-back-end-component-vulnerabilities-010)
- [x] [02. Instructor Do: Directory Traversal](LessonPlan.md#02-instructor-do-directory-traversal-020)
- [x] [03. Student Do: Directory Traversal Activity](LessonPlan.md#03-student-do-directory-traversal-activity-020)
- [x] [04. Instructor Review: Directory Traversal Activity](LessonPlan.md#04-instructor-review-directory-traversal-activity-010)
- [x] [05. Break](LessonPlan.md#05-break-020)
- [x] [06. Instructor Do: Web Application Back-End Code](LessonPlan.md#06-instructor-do-web-application-back-end-code-015)
- [x] [07. Instructor Do: Local File Inclusion](LessonPlan.md#07-instructor-do-local-file-inclusion-015)
- [x] [08. Student Do: Local File Inclusion Activity](LessonPlan.md#08-student-do-local-file-inclusion-activity-020)
- [x] [09. Instructor Review: Local File Inclusion Activity](LessonPlan.md#09-instructor-review-local-file-inclusion-activity-010)
- [x] [10. Instructor Do: Remote File Inclusion](LessonPlan.md#10-instructor-do-remote-file-inclusion-010)
- [x] [11. Student Do: Remote File Inclusion Activity](LessonPlan.md#11-student-do-remote-file-inclusion-activity-020)
- [x] [12. Instructor Review: Remote File Inclusion Activity](LessonPlan.md#12-instructor-review-remote-file-inclusion-activity-010)

## Slideshow and Time Tracker

The lesson slides are available on Google Drive here: [15.2 Slides](https://docs.google.com/presentation/d/1hIIzvqDHKtLSygkVg_e_47bwx0jWHzPnSKasmTAURvQ/edit).
