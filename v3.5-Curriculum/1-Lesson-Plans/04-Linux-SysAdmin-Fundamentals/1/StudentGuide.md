...
- [x] [01. So, Why Linux?](#01-so-why-linux)
- [x] [02. Linux History and Distributions](#02-linux-history-and-distributions)
- [x] [03. Activity: Distribution Research](#03-activity-distribution-research)
- [x] [04. Review: Distribution Research](#04-activity-review-distribution-research)
- [x] [05. Linux File System Structure](#05-linux-file-system-structure)
- [x] [06. Activity: Linux Landmarks](#06-activity-linux-landmarks)
- [x] [07. Review: Linux Landmarks](#07-activity-review-linux-landmarks)
- [x] [08. Break](#08-break)
- [x] [09. Resources and Processes](#09-resources-and-processes)
- [x] [10. Activity: Process Investigation](#10-activity-process-investigation)
- [x] [11. Review: Process Investigation](#11-activity-review-process-investigation)
- [x] [12. Installing Packages](#12-installing-packages)
- [x] [13. Student Take-Home Activity: Installing Packages](#13-take-home-activity-installing-packages)
- [x] [14. Take-Home Activity Review: Installing Packages](#14-take-home-activity-review-installing-packages)



### Slideshow

The slides for today can be viewed on Google Drive here: [4.1 Slides](https://docs.google.com/presentation/d/1__JnFI8VdrXMu43AVuOqtLdYDdVEP8MHwUJyAg1uZg0/edit?usp=drive_link)
