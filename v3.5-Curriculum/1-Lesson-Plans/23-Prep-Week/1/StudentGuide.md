...
- [x] [01. Welcome to Career Prep Week](#01-welcome-to-career-prep-week)
- [x] [02. Introduction to Information Security Certifications](#02-introduction-to-information-security-certifications)
- [x] [03. Activity: Certifications and Careers](#03-activity-certifications-and-careers)
- [x] [04. Activity Review: Certifications and Careers Activity](#04-activity-review-certifications-and-careers)
- [x] [05. Certification Pathways](#05-certification-pathways)
- [x] [06. Activity: Find a Certification Pathway](#06-activity-find-a-certification-pathway)
- [x] [07. Activity Review: Certification Pathway Activity](#07-activity-review-find-a-certification-pathway)
- [x] [08. Break](#08-break)
- [x] [09. Introduction to Security+](#09-introduction-to-security)
- [x] [10. Security+ CertMaster](#10-security-certmaster)
- [x] [11. Activity: Security+ CertMaster Activity](#11-activity-security-certmaster)
- [x] [12. Activity Review: Security+ CertMaster Activity](#12-activity-review-security-certmaster)
- [x] [13. Security+ PBQ](#13-security-pbqs)
- [x] [14. Activity: Security+ PBQs](#14-activity-security-pbqs)
- [x] [15. Activity Review: Security+ PBQs Activity and Wrap-Up](#15-activity-review-security-pbqs)
...
### 04. Activity Review: Certifications and Careers

[<- Back to Module Contents](#module-day-1-contents)

---

### 05. Certification Pathways 
...
**Offensive Security Certified Professional (OSCP)** is a specialized pen testing certification offered by Offensive Security. 
...
**Certified Information Privacy Professional (CIPP)** is a specialized privacy certification offered by the IAPP.
...
### 06. Activity: Find a Certification Pathway
...
### 07. Activity Review: Find a Certification Pathway
...
- There is only one module within **Security+ Sample Learning Module**.
  ...
  - The dashboard provides the following details on each module:
    ...
    - The image provides a sample of what the full version will include.
...
### 11. Activity: Security+ CertMaster
...
### 12. Activity Review: Security+ CertMaster
...
### 15. Activity Review: Security+ PBQs
