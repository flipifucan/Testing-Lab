...
- Today's lesson includes an optional activity: 06. Optimizing with Asymmetric Public Keys Activity. 
  ...
  - If there is time in class do the activity, otherwise encourage students to do it on their own time and then review during office hours if needed. 
...
- [x] [03. Instructor Review: Cryptography Refresher](LessonPlan.md#03-instructor-review-cryptography-refresher-005)
- [x] [04. Instructor Do: Introduction to Key Management and Exchange](LessonPlan.md#04-instructor-do-introduction-to-key-management-and-exchange-007)
- [x] [05. Instructor Do: Asymmetric/Public Key Cryptography](LessonPlan.md#05-instructor-do-asymmetricpublic-key-cryptography-015)
- [x] [06. (Optional) Student Do: Optimizing with Asymmetric Public Keys Activity](LessonPlan.md#06-optional-student-do-optimizing-with-asymmetric-public-keys-activity-000)
- [x] [07. (Optional) Instructor Review: Optimizing with Asymmetric Public Keys Activity](LessonPlan.md#07-optional-instructor-review-optimizing-with-asymmetric-public-keys-activity-000)
- [x] [08. Instructor Do: Applying Public Key Cryptography with GPG](LessonPlan.md#08-instructor-do-applying-public-key-cryptography-with-gpg-010)
- [x] [09. Student Do: GPG Activity](LessonPlan.md#09-student-do-gpg-activity-020)
- [x] [10. Instructor Review: GPG Activity](LessonPlan.md#10-instructor-review-gpg-activity-005)
- [x] [11. Break](LessonPlan.md#11-break-015)
- [x] [12. Instructor Do: Hashing and Data Integrity](LessonPlan.md#12-instructor-do-hashing-and-data-integrity-010)
- [x] [13. Student Do: Generating Hashes Activity](LessonPlan.md#13-student-do-generating-hashes-activity-017)
- [x] [14. Instructor Review: Generating Hashes Activity](LessonPlan.md#14-instructor-review-generating-hashes-activity-005)
- [x] [15. Instructor Do: Digital Signatures](LessonPlan.md#15-instructor-do-digital-signatures-010)
- [x] [16. Instructor Do: Signing with GPG](LessonPlan.md#16-instructor-do-signing-with-gpg-010)
- [x] [17. Student Do: Digital Signatures Activity](LessonPlan.md#17-student-do-digital-signatures-activity-020)
- [x] [18. Instructor Review: Digital Signatures Activity](LessonPlan.md#18-instructor-review-digital-signatures-activity-005)
...
- In this upcoming activity, you will use the key and IV that you created in the previous class and saved into a file called `key_and_IV`. 
...
Remind students that the point of this exercise was to review how to use OpenSSL and then illustrate the challenge that securely exchanged keys pose to security professionals.
...
Completing this activity required the following steps:
  ...
  - Receive your partner's message, key, and IV and decrypt it with OpenSSL.
...
**Instructor Note:** Since each student has a different key and IV, each result will be different. If needed, use the following example to illustrate how to encrypt and decrypt with OpenSSL.
...
Point out that if Tim and Julie each needed to send messages to each other, four keys would be required for a secure communication:
...
Explain that, similar to symmetric encryptions' use of modern algorithms such as DES, 3DES, and AES, asymmetric encryption uses an algorithm called **RSA**.
...
- You will continue to be a security analyst working for the Hill Valley Police Department.
...
Remind students that the goal of this activity was to compare key distributions and the number of required keys for asymmetric encryption and symmetric encryption.
...
If you are using a single machine, you can open two terminal windows in your VM
  ...
  - Explain that GPG is already preinstalled on your VM for use, and is also already installed in Ubuntu.
...
- #### Step 2: Exporting and Importing Keys
  ...
  Explain that Julie needs to **export** her public key to make it public, so Tim can use it.
    ...
    - Point out that the results should resemble the following format:
...
- #### Step 4: Decryption
  ...
  Explain that the last step is for Tim to send his encrypted message over to Julie so that she can decrypt it with her private key.
...
- You continue to be a security analyst working for the Hill Valley Police Department.
...
- Explain that at first glance, hashing may look similar to encryption, as you are unable to understand the resulting message.
...
Completing this activity required the following steps:
  ...
  - Extracting the investigation summary files
...
Explain that we will illustrate how digital signatures work with public key cryptography using the following scenario:
...
Illustrate that this scenario shows how digital signatures can also be used for integrity and non-repudiation:
...
- Point out that the signature should look like the following:  
  ```
        -----BEGIN PGP SIGNATURE-----
...
- **Step 2: Validating the Signature Again**
  ...
  - Point out that this now clearly shows that the signature failed.
...
- [Solution Guide: Digital Signature](activities/17_Digital_Signature_Activity/solved/readme.md)
