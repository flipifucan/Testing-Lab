...
- [x] [01. Welcome to Splunk](#01-welcome-to-splunk)
- [x] [02. Splunk Capabilities](#02-splunk-capabilities)
- [x] [03. Activity: Splunk Features](#03-activity-splunk-features)
- [x] [04. Activity Review: Splunk Features Activity](#04-activity-review-splunk-features)
- [x] [05.  Tour of Splunk and Splunk Setup](#05-tour-of-splunk-and-splunk-setup)
- [x] [06. Adding Data into Splunk](#06-adding-data-into-splunk)
- [x] [07. Activity: Uploading Data Into Splunk Activity](#07-activity-uploading-data-into-splunk)
- [x] [08. Activity Review: Uploading Data Into Splunk Activity](#08-activity-review-uploading-data-into-splunk)
- [x] [09. Break](#09-break)
- [x] [10. Splunk Searching](#10-splunk-searching)
- [x] [11. Activity: SPL Search](#11-activity-spl-search)
- [x] [12. Activity Review: SPL Search Activity](#12-activity-review-spl-search)
- [x] [13. Searching Fields with Splunk](#13-searching-fields-with-splunk)
- [x] [14. Activity: Searching Fields with Splunk](#14-activity-searching-fields-with-splunk)
- [x] [15. Activity Review: Searching Fields with Splunk Activity](#15-activity-review-searching-fields-with-splunk)
- [x] [16. Advanced Searches with Piping](#16-advanced-searches-with-piping)
- [x] [17. Activity: Advanced Searches with Piping](#17-activity-advanced-searches-with-piping)
- [x] [18. Activity Review: Advanced Searches with Piping Activity](#18-activity-review-advanced-searches-with-piping)
...
### 04. Activity Review: Splunk Features
